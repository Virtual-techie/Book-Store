...
import { COLORS, SIZES, icons, images } from '../design';
...
const Home = ({ navigation }) => {
    ...
    const profileData = {
        name: 'Shitanshu Goyal',
        point: 200
    }

    const RichdadpoorDad = {
        id: 1,
        bookName: "Rich Dad Poosr Dad",
        bookCover: images.RichdadpoorDad,
        rating: 4.9,
        language: "Eng",
        pageNo: 224,
    ...
    // It will display all the categories
    const categoriesData = [
        {
            id: 1,
            categoryName: "Best Seller",
            books: [
                RichdadpoorDad,AtomicHabits
            ]
        },
        {
            id: 2,
            ...
            <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: SIZES.padding, alignItems: 'center' }}>
                ...
                >
                    <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <Text style={{ marginLeft: SIZES.base, color: COLORS.white,  }}>{profile.point} point</Text>
                    </View>
                </TouchableOpacity>
            </View>
        )
